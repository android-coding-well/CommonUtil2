...
public class LoadToast {
    ...
    public LoadToast(Context context){
        ...
        mParentView.postDelayed(new Runnable() {
            ...
            public void run() {
               ...
               // ViewHelper.setTranslationY(mView,(mParentView.getHeight() - mView.getHeight())/2);
                mInflated = true;
    ...
    public LoadToast setText(int  messageId){
    ...
    public LoadToast show(){
        ...
        ViewHelper.setTranslationY(mView, -mView.getHeight() + mTranslationY);
        L.i("" + (-mView.getHeight() + mTranslationY));
        //ViewHelper.setTranslationY(mView, (mParentView.getHeight() - mView.getHeight())/2);
    ...
    public void dismiss(){
        ...
        ViewPropertyAnimator.animate(mView).setStartDelay(1).alpha(0f)
